...
[Blumofe and Leiserson](http://supertech.csail.mit.edu/papers/steal.pdf) proves that the optimal time complexity is https://render.githubusercontent.com/render/math?math=\frac{T_1}{P}%2BO(T_\infinity).
